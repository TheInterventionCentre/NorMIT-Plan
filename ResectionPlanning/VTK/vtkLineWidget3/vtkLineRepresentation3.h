...
#define vtkLineRepresentation3_h
...
class VTKINTERACTIONWIDGETS_EXPORT vtkLineRepresentation3 : public vtkWidgetRepresentation
{
public:
  /**
   * Instantiate the class.
   */
  static vtkLineRepresentation3 *New();

  //@{
  /**
   * Standard methods for the class.
   */
  vtkTypeMacro(vtkLineRepresentation3,vtkWidgetRepresentation);
...
private:
  vtkLineRepresentation3(const vtkLineRepresentation3&) VTK_DELETE_FUNCTION;
  void operator=(const vtkLineRepresentation3&) VTK_DELETE_FUNCTION;
};
